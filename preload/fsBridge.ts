...
contextBridge.exposeInMainWorld("tokenringFS", {
  readFile: (data: unknown): MaybePromise<{ success: boolean; content?: string | undefined; error?: string | undefined }> => {
  ...
  writeFile: (data: unknown): MaybePromise<{ success: boolean; error?: string | undefined }> => {
  ...
  exists: (data: unknown): MaybePromise<{ success: boolean; exists?: boolean | undefined }> => {
  ...
  stat: (data: unknown): MaybePromise<{ success: boolean; stats?: object; error?: string | undefined }> => {
